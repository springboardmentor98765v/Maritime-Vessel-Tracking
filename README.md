...
A comprehensive real-time vessel tracking platform with live AIS integration, port congestion analytics, and safety monitoring.
...
backend/
├── apps/
│   ├── authentication/    # JWT auth, user management, password reset
│   ├── vessels/           # Vessel tracking, events, subscriptions
│   ├── ports/             # Port congestion analytics
│   ├── voyages/           # Voyage history and replay
│   ├── notifications/     # User notifications system
│   └── admin/             # Admin dashboard tools
├── integrations/          # External APIs (NOAA, AIS Hub, MarineTraffic)
...
**Integrations:**
- AIS Hub (real-time vessel positions)
- NOAA (weather alerts)
- MarineTraffic (vessel metadata)
- UNCTAD (port statistics)


## ⚡ Features

- ✅ Real-time vessel tracking with live AIS data
- ✅ Port congestion analytics
- ✅ Safety event monitoring (weather, piracy)
